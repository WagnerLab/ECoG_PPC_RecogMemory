function plotFigure3(data1,data2,data3,data4,opts)
...
if 0
    ...
    axes('position', [0.1+vBarW+scatterW+0.08, yPos(1)-0.03, vBarW*2, hBarH]); hold on;
    for ss=1:4
...
if 1
    ...
    yTicks      = [-0.05 0 0.05];
    chIdx{1}   = data1.ROIid==1 & data1.hemChanId==1;
    chIdx{2}   = data1.ROIid==2 & data1.hemChanId==1;
    ...
    sigBar      = cell(2,1);
    sigBar{1}   = [0.065 0.065];
    sigBar{2}   = [0.068 0.068];
