% scratch_subj29 SS2 / JT

%% SS2
% Setup parameters
expt = 'SS2';
subj = 'subj30';
blocklist = {'RR_48', 'RR_50', 'RR_52', 'RR_54','RR_56','RR_106','RR_108'};

addpath(genpath( '/Volumes/group/awagner/biac3/wagner7/ecog/scripts/alex/'))
addpath(genpath( '~/Documents/MATLAB/Mylib/vistasoft/'))

%basepath
% basepath = ['/Users/anthonywagner/biac4-wagner/biac3/wagner7/ecog/' subj '/ecog/' expt];
basepath = ['/Volumes/group/awagner/biac3/wagner7/ecog/' subj '/ecog/' expt];
...
%     ecogBatch_AIN(subj(5:end),blocklist{b},'pt'); 
% end

overwrite=1;
for b=6%1:length(blocklist)
    alg_ecogBatch_SS2(subj(5:end),blocklist{b},'t',basepath,bef_win,aft_win,overwrite); 
end
