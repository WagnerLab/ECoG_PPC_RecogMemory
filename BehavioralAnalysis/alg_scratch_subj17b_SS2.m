...
expt = 'SS2';
subj = 'subj17b';
%blocklist = {'RHb0211-04', 'RHb0211-09', 'RHb0211-11'};
blocklist = { 'RHb0211-09', 'RHb0211-11'}; % block one no pdio info 
...
overwrite=1;
for b=1:length(blocklist)
    alg_ecogBatch_SS2(subj(5:end),blocklist{b},'c',basepath,bef_win,aft_win,overwrite); 
end
